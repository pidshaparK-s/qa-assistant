---
name: meeting-mode
description: 'Real-time conversational interrogation ระหว่าง meeting กับ PM ไม่ใช่ pipeline — ไม่มี phases ไม่มี output file ไม่มี completion gate พิมพ์ requirement มา → ได้คำถามกลับทันที พร้อม gaps และ PM challenge phrases Trigger: "meeting mode" หรือ "โหมดประชุม" ออก: "end meeting" หรือ "โหมดออก"'
---
