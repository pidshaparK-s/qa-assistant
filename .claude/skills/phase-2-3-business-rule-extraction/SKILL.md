...
description: 'ใช้ skill นี้หลังจากได้ AC มาแล้ว เมื่อต้องการแยก logic ที่ซ่อนอยู่ใน AC ออกมาเป็น Business Rule ที่ทีมใช้อ้างอิงร่วมกันได้ Skill นี้ใช้เทคนิค "Why" จาก phase-1-1 เป็นเครื่องมือหลักในการขุด BR แล้วจัดประเภทเป็น 4 ชนิด (permission, constraint, computation, state) พร้อมรูปแบบการเขียนที่ใช้ได้จริงใน Jira Trigger เมื่อ: มี AC ที่ logic เดียวกันปรากฏในหลาย story, dev ถามว่า "แล้วกฎนี้ใช้ที่ไหนบ้าง?", หรือก่อน sprint เริ่มเพื่อ consolidate rules'
---
