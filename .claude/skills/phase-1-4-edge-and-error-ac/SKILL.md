...
description: 'ใช้ skill นี้หลังจากเขียน Happy Path AC แล้ว (phase-1-3) เมื่อต้องการ หา Edge Case และ Error Case ที่ยังขาดอยู่ใน story Skill นี้เน้นที่ "วิธีหา" ก่อน ไม่ใช่แค่ "วิธีเขียน" เพราะ Edge Case ไม่ได้โผล่ออกมาชัดเจนเหมือน Happy Path — ต้องใช้ mental model เพื่อขุดออกมาจาก boundary, environment, และ timing ของ system Trigger เมื่อ: เขียน Happy Path AC ครบแล้วแต่รู้สึกว่ายังไม่ครอบคลุม, ต้องการตรวจสอบ AC ก่อน sprint เริ่ม, หรือกำลังทำ gap analysis กับ story จริง'
---
