...
description: 'ใช้ skill นี้เมื่อต้องเขียน User Story ใหม่จาก requirement หรือ feature idea หรือเมื่อต้องตรวจสอบ/ปรับ User Story ที่มีอยู่ให้ผ่าน INVEST Skill นี้สอนวิธีเขียนโครงสร้าง As a/I want/So that ให้ "So that" บอก business value จริง สอนวิธีทดสอบแต่ละตัวอักษรของ INVEST และสอนว่าเมื่อไหรควรแตก story (แตกตาม method ไม่ใช่ตาม role) รวมถึงกรณีพิเศษที่ role out-of-scope เป็น AC ไม่ใช่ story Trigger เมื่อ: เขียน story ใหม่, story ดูใหญ่หรือกว้างเกินไป, ไม่แน่ใจว่าควรแตกไหม, หรือต้องการ review story ก่อนเข้า backlog'
---
