...
description: >
  ใช้ skill นี้เมื่อต้องการวิเคราะห์ requirement ที่ได้รับมาก่อนเริ่ม implement หรือ
  เขียน test case — ไม่ว่าจะเป็น requirement จาก PM, ลูกค้า, หรือ Jira story
  Skill นี้ช่วยตั้งคำถาม Who/What/Why อย่างมีโครงสร้าง โดยใช้ Relationship Map
  สำหรับ Who, State Machine สำหรับ What, และ Pain & Consequence Analysis สำหรับ Why
  Trigger เมื่อ: ได้รับ requirement ใหม่, กำลัง refinement session,
