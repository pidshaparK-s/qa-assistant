...
description: >
  ใช้ skill นี้ก่อน sprint เริ่มเสมอ เพื่อ define ว่าอะไรอยู่ใน scope,
  อะไรไม่อยู่, อะไรที่ยัง assume โดยไม่มีใครยืนยัน, และอะไรที่ยังไม่รู้คำตอบ
  Skill นี้คือ "gate" สุดท้ายก่อน sprint — ถ้าข้าม step นี้ทีมจะ build
  โดยไม่มีใครตกลงกันก่อนว่าอะไรอยู่ใน scope และเกิด scope creep ระหว่าง sprint
  Trigger เมื่อ: ก่อน sprint planning, หลังเขียน AC ครบแล้วแต่รู้สึกว่ายังมีอะไรขาด,
  PM พูดถึง feature ที่ไม่ได้อยู่ใน AC, หรือทีมถกเถียงกันว่าอะไร "อยู่ใน scope" ไหม
---
